    ...
    function insertSearch( id, catchRemote ) {
        ...
        for ( var i = 0, ci; ci = imgs[i++]; ) {
            if ( ci.getAttribute( "selected" ) ) {
                ...
                var data_ue_src = ci.getAttribute( "data_ue_src", 2 ).replace( /(\s*$)/g, "" ), img = {};
                img.src = data_ue_src;
                img.data_ue_src = data_ue_src;
                imgObjs.push( img );
            }
        }
        insertImage(imgObjs);
                        ...
                        ajax.request( editor.options.imageManagerUrl, {
                            ...
                            onsuccess:function ( xhr ) {
                                ...
                                for ( var k = 0, ci; ci = imageUrls[k++]; ) {
                                    ...
                                    img.setAttribute( k < 35 ? "src" : "lazy_src", editor.options.imageManagerPath + ci.replace(/\s+|\s+/ig,"") + "?imageView2/5/w/60/h/60" );
