...
function init_view_customer_service_company_integrated_notice_inform() {
    /**
     * 通知公告
     * by 刘奕辰 2015-6-25
     */
  ...
  /**
     ...
     */
        ...
        EJSTemplateRender('cp_manage/ejs/customer_service_company_integrated_all.ejs',{id:null}).done(function (html) {
            $('#view_content').html(html);
            //window.viewDTD.resolve();
