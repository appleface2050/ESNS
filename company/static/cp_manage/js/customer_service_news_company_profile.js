...
function init_view_customer_service_news_company_profile() {
   ...
   /**
    ...
    function showView() {
         ...
         *优化查询
         by: 闫宇 at:2015-06-27
         */
        show_breadcrumb([{name: '公司简介'}]);

         httpRequest('/cp/'+window.companyid+'/get_child_comapny_column_list', {flag:'GONGSIJIANJIE'}).then(function (data) {
            if (!data.result) {
                return "";
            }
