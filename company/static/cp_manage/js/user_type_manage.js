...
function init_view_user_type_manage() {
    ...
    function showView() {
        ...
        EJSTemplateRender('cp_manage/ejs/user_type_manage.ejs').done(function (html) {
    ...
    window.query_user = function () {
        ...
        httpRequest('/cp/query_user', {keyword: keyword, user_type: user_type}).then(function (data) {
            if (!data.result) {
                return "";
            }
            return EJSTemplateRender('cp_manage/ejs/user_type_manage_table_data.ejs', data);
        }).then(function (html) {
            $('tbody').html(html);
        });
    };
            ...
            buttons: {
                ...
                "button": {
                    ...
                    "callback": function () {
                        ...
                        httpRequest('/cp/set_user_type', obj).done(function () {
                            query_user();
