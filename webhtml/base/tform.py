        ...
        if self.model != None:
            ...
            for field in self.model._meta.fields:
                if field.name == self.filed_name:
                    ...
                    if hasattr(self, 'max_length') and not self.max_length:
...
class TextField(Field):
    ...
    by:范俊伟 at:2015-01-21
    """
    template = 'webhtml/include/form_field_text.html'
    max_length = None
...
class DateTimeField(Field):
    ...
    by:范俊伟 at:2015-01-21
    """
    template = 'webhtml/include/form_field_datetime.html'
    date = None
    time = None
...
class CheckboxField(Field):
    ...
    by:范俊伟 at:2015-01-21
    """
    template = 'webhtml/include/form_field_checkbox.html'
    value = False
...
class HiddenField(Field):
    ...
    by:范俊伟 at:2015-01-21
    """
    template = 'webhtml/include/form_field_hidden.html'
...
class PasswordField(TextField):
    ...
    by:范俊伟 at:2015-01-21
    """
    template = 'webhtml/include/form_field_password.html'
...
class SelectField(Field):
    ...
    by:范俊伟 at:2015-01-21
    """
    template = 'webhtml/include/form_field_select.html'
    choices = []
...
class DateField(Field):
    ...
    by:范俊伟 at:2015-01-21
    """
    template = 'webhtml/include/form_field_date.html'
    date = None
    time = None
...
class CityField(Field):
    ...
    """
    template = 'webhtml/include/form_field_city.html'
    emtpy = None

    def __init__(self, emtpy=None, **kwargs):
        '''
        初始化
        by: 范俊伟 at:2015-02-14
        '''
        self.emtpy = emtpy
        super(CityField, self).__init__(**kwargs)
